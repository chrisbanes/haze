...
class GlassContentScreenshotTest : ScreenshotTest() {
  ...
  fun creditCard_chromatic() = runScreenshotTest {
    val visualEffect = GlassTestConfiguration().apply {
      tint = DefaultTint
      optics = GlassOptics(refractionStrength = 0.8f, depth = OpticalSizeValue.Fixed(0.5f))
  ...
  fun creditCard_surfaceProfile() = runScreenshotTest {
    val visualEffect = GlassTestConfiguration().apply {
      tint = DefaultTint
      optics = GlassOptics(refractionHeightFraction = 0.28f, depth = OpticalSizeValue.Fixed(0.4f))
  ...
  fun creditCard_chromaticAberrationMode() = runScreenshotTest {
    val visualEffect = GlassTestConfiguration().apply {
      tint = DefaultTint
      optics = GlassOptics(refractionStrength = 0.8f, depth = OpticalSizeValue.Fixed(0.45f))
    ...
    val VibrantStyle = GlassStyle {
      ...
      optics(
        GlassOptics(
          ...
          depth = OpticalSizeValue.Fixed(0.35f),
        ),
      )

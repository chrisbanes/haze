We provide off of the shelf implementations of [HazeStyle](api/haze-blur/dev.chrisbanes.haze.blur/-haze-style/index.html)s which implement 'materials' of various styles.

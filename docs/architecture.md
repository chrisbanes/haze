...
`BlurVisualEffect` runtime that owns its resolved snapshot, invalidation state, performance-mode
resolution, delegate, retained output, render-effect cache, and platform resources. Style replacement

...
internal enum class GlassProfilingScenario(
  ...
  StableFixed0(
    id = "stable_fixed_0",
    steadyDraw = true,
    performanceMode = HazePerformanceMode.Fixed(0f),
  ),
  StableFixed25(
    id = "stable_fixed_25",
    steadyDraw = true,
  ...
  StableFixed33(
    id = "stable_fixed_33",
    steadyDraw = true,
    performanceMode = HazePerformanceMode.Fixed(1f / 3f),
  ),
  StableFixed50(
    id = "stable_fixed_50",
    steadyDraw = true,
  ...
  StableFixed75(
    id = "stable_fixed_75",
    steadyDraw = true,
    performanceMode = HazePerformanceMode.Fixed(0.75f),
  ),
  StableFixed100(
    id = "stable_fixed_100",
    steadyDraw = true,
  ...
  SourceUpdateFixed0(
    id = "source_update_fixed_0",
    performanceMode = HazePerformanceMode.Fixed(0f),
  ),
  SourceUpdateFixed25(
    id = "source_update_fixed_25",
    performanceMode = HazePerformanceMode.Fixed(0.25f),
  ),
  SourceUpdateFixed33(
    id = "source_update_fixed_33",
    performanceMode = HazePerformanceMode.Fixed(1f / 3f),
  ),
  SourceUpdateFixed50(
    id = "source_update_fixed_50",
    performanceMode = HazePerformanceMode.Fixed(0.5f),
  ),
  SourceUpdateFixed75(
    id = "source_update_fixed_75",
    performanceMode = HazePerformanceMode.Fixed(0.75f),
  ),
  SourceUpdateFixed100(
    id = "source_update_fixed_100",
    performanceMode = HazePerformanceMode.Fixed(1f),
  ),

    ...
    repeat(3) { index ->
      ...
      card(
        ...
        Modifier
          ...
          .offset { IntOffset(x = 0, y = cardOffset.floatValue.toInt()) }
          .draggable(
            state = draggableState,
            orientation = Orientation.Vertical,
            onDragStopped = { velocity ->
              animate(
                initialValue = cardOffset.floatValue,
                targetValue = 0f,
                initialVelocity = velocity,
                animationSpec = spring(Spring.DampingRatioLowBouncy, Spring.StiffnessLow),
              ) { value, _ ->
                cardOffset.floatValue = value
              }
            },
          ),
        shape,
...
@Composable
private fun CreditCardBackground(hazeState: HazeState) {
  Box(
    modifier = Modifier
      .fillMaxSize()
...
@Composable
internal fun DefaultCreditCardContents(modifier: Modifier = Modifier) {

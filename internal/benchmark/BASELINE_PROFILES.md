...
For the retained final profile, the verifier reports 2,255 rules (211 class and 2,044 method), zero
missing ordinary AAR members, and zero missing consumer-Dex members. Its ordinary counts are `476`
(`haze`), `331` (`haze-blur`), `1,082` (`haze-glass`), `42` (`haze-utils`), `7`
(`haze-materials`), and `3` (`haze-glass-material3`). The expected generated counts are 291
external-synthetic entries, 14 lambda bridges, 16 `$-CC` interface companions, and one

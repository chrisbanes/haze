...
class HazeBlurStyleTest {
  ...
  @Test
  fun defaultStyle_usesPublicEnablementQuery() {
    assertThat(resolveHazeBlurStyle(HazeBlurStyle, HazeBlurStyle).blurEnabled)
      .isEqualTo(HazeBlurDefaults.isBlurEnabledByDefault())
  }

...
internal val VERTICAL_BLUR_SKSL: String by lazy(mode = LazyThreadSafetyMode.NONE) {
  makeBlurSksl(true)
}
internal val HORIZONTAL_BLUR_SKSL: String by lazy(mode = LazyThreadSafetyMode.NONE) {
  makeBlurSksl(false)
}

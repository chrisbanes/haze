...
internal val RUNTIME_SHADER: RuntimeEffect by lazy(LazyThreadSafetyMode.NONE) {
...
internal val VERTICAL_BLUR_SHADER: RuntimeEffect by lazy(LazyThreadSafetyMode.NONE) {
  RuntimeEffect.makeForShader(VERTICAL_BLUR_SKSL)
}
internal val HORIZONTAL_BLUR_SHADER: RuntimeEffect by lazy(LazyThreadSafetyMode.NONE) {
  RuntimeEffect.makeForShader(HORIZONTAL_BLUR_SKSL)
}

internal val NOISE_SHADER by lazy(LazyThreadSafetyMode.NONE) {

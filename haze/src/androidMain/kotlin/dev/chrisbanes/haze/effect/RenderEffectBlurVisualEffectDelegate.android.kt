...
private fun RenderEffectBlurVisualEffectDelegate.drawLinearGradientProgressiveEffectUsingLayers(
  ...
  val node = blurVisualEffect.attachedNode ?: return
  val tints = blurVisualEffect.resolveTints()
  val noiseFactor = blurVisualEffect.resolveNoiseFactor()
  val blurRadius = blurVisualEffect.resolveBlurRadius().takeOrElse { 0.dp } *

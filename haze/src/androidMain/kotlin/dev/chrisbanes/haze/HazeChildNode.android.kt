...
internal actual fun HazeChildNode.drawLinearGradientProgressiveEffect(
  ...
  drawLinearGradientProgressiveEffectBackCompat(drawScope, progressive, contentLayer)
}

private fun HazeChildNode.drawLinearGradientProgressiveEffectBackCompat(
  drawScope: DrawScope,
  progressive: HazeProgressive.LinearGradient,
  contentLayer: GraphicsLayer,
) = with(drawScope) {

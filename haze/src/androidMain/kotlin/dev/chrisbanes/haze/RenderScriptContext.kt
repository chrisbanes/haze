...
internal class RenderScriptContext(
  ...
  private val outputDrawnChannel = Channel<Unit>(Channel.CONFLATED)
    ...
    if (useHwBuffer) {
      ...
      imageReader.setOnImageAvailableListener(
        { imageReader ->
          ...
          val buffer = outputImage.hardwareBuffer!!
          outBmp = Bitmap.wrapHardwareBuffer(buffer, colorSpace)
          buffer.close()
          outputImage.close()
          outputDrawnChannel.trySend(Unit)
